========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : can_control
========================================================================


Diese can_control-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre can_control-Anwendung bilden.
...
can_control.h
	...
	Anwendungsklasse CCan_controlApp.
...
res\can_control.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei can_control.rc eingebunden.
...
can_controlDlg.h, can_controlDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CCan_controlDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in can_control.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	can_control.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
